# 100 Days Of Code Log - Round 1 - Anwana Ntofon
...
**Thoughts** Even if it's one a day, I'm glad I can still make progress by completing challenges.
...
**Thoughts** Completed a challenge that I didn't even understand? A bit of plug-n-chug with a lot of hoping. It's all good though, when I went back to understand it, the solution made sense. Two more to go!
...
### Day 70: December 12 2017, Tuesday

**Today's Progress**: Completed Wikipedia Viewer Project. Implemented proper functionality of user search, added link to go to corresponding query wiki pages, and added random article link.

**Thoughts** Wow, really finished this project. The original search implementation was all "wrong"! Once I found the page that helped me construct a better query search URL, I knew I was in the right direction. That and also actually testing out what results come up if I entered a value in Wikipedia's search field. After that I just kept building on what I said I would accomplish within the next two days. Really happy that I buckled down and finished it all today.  
...
### Day 77: December 19 2017, Tuesday

**Today's Progress**: Started work on React Exercise: Make a React Website.

**Thoughts** Thankfully I have the react skeleton as my template. Trying not to look at code and really think about what I'm doing. It's going to be tough but once I make it through I'll have a deeper understanding of how to approach React.
...
### Day 79: December 21 2017, Thursday

**Today's Progress**: Working more on React Exercise: Make a React Website. Did some of React course on Codecademy.

**Thoughts** Just repetition, constantly working on React to increase my understanding.
